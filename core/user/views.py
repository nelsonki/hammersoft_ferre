...
class UserListView(Configuration, LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    model = User
...
class UserCreateView(Configuration, LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    model = User
    form_class = UserForm
...
class UserUpdateView(Configuration, LoginRequiredMixin, ValidatePermissionRequiredMixin, UpdateView):
    model = User
    form_class = UserForm
    template_name = 'user/create.html'
    success_url = reverse_lazy('user:user_list')
...
class UserDeleteView(Configuration, LoginRequiredMixin, ValidatePermissionRequiredMixin, DeleteView):
    model = User
...
class UserChangeGroup(Configuration, LoginRequiredMixin, View):
...
class UserProfileView(Configuration, LoginRequiredMixin, UpdateView):
    model = User
...
class UserChangePasswordView(Configuration, LoginRequiredMixin, FormView):
    model = User
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = self.success_url
        context['cancelar'] = reverse_lazy('dashboard')
        context['action'] = 'edit'
        return context
